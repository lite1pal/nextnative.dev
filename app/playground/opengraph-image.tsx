...
export default async function Image() {
  ...
  const title = "Free NextNative Playground"!.slice(0, 120);

  const desc =
    "Try NextNative Playground to explore files and see a live mobile simulator with included mobile apps"!.slice(
      0,
      160,
    );
