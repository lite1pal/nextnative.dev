...
export default async function Image() {
  ...
  const title =
    "Cost to Publish App on App Store 2025: Complete Fee Breakdown"!.slice(
      0,
      120,
    );

  const desc =
    "Complete breakdown of costs to publish your app on Apple App Store and Google Play Store."!.slice(
      0,
      160,
    );
