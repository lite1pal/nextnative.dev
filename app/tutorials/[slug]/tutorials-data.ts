...
export const tutorials: Tutorial[] = [
  {
    ...
    metaDescription:
      "Step-by-step guide to convert your Next.js web app into native iOS and Android mobile apps using Capacitor. Includes code examples and deployment tips.",
...
npx cap sync`,
  ...
  },
  {
    ...
    metaDescription:
      "Complete guide to implementing push notifications in your Next.js mobile app using Capacitor and Firebase Cloud Messaging. Works on iOS and Android.",
    category: "features",
...
6. Click "Test"`,
  ...
  },
  {
    ...
    metaDescription:
      "Complete guide to implementing in-app purchases and subscriptions in your Next.js mobile app using RevenueCat. Works on iOS and Android.",
    category: "features",
    difficulty: "intermediate",
...
export async function checkPremiumStatus(): Promise<boolean> {
  ...
  },
  {
    ...
    metaDescription:
      "Learn how to build and publish an iOS app using Next.js and Capacitor. Step-by-step tutorial from setup to App Store submission.",
    category: "getting-started",
    difficulty: "beginner",
    timeToComplete: "45 minutes",
    lastUpdated: "October 2025",
...
5. Trust the developer certificate on your device`,
  ...
  },
  {
    ...
    metaDescription:
      "Complete guide to submitting your Next.js mobile app to the Apple App Store. Covers app preparation, TestFlight, and App Store submission.",
    category: "deployment",
    difficulty: "intermediate",
