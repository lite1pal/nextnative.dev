...
export default async function Image() {
  ...
  const title =
    "Free App Icon & Splash Screen Generator (iOS & Android)"!.slice(0, 120);

  const desc =
    "Upload one image and instantly get all required app icon and splash sizes for iOS & Android. 100% free, no signup."!.slice(
      0,
      160,
    );
