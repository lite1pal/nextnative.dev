  ...
  return (
    <div className="mx-auto max-w-4xl py-16">
      ...
      <p className="mb-10 text-center text-gray-600">
        Find the best keywords for your App Store or Google Play listing. <br />
        Discover keyword ideas, difficulty, and estimated search volume.
      </p>
      ...
      <div className="mt-8 rounded-2xl bg-gray-50 p-4 text-center text-sm text-gray-600">
        <p>
          ...
          estimates based on industry data. For precise data, use Apple's Search
          Ads or Google Play Console analytics.
        </p>
      </div>
