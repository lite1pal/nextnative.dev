...
export default async function Image() {
  ...
  const title = "App Store Metadata Generator"!.slice(0, 120);

  const desc =
    "Generate iOS App Store titles, subtitles, keywords CSV, and Google Play descriptions from a few inputs."!.slice(
      0,
      160,
    );
