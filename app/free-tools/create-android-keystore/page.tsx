  ...
  return (
    <div className="mx-auto max-w-3xl py-16">
      ...
      <p className="mb-10 text-center text-gray-600">
        Generate the keytool command to create an Android keystore file for
        signing your APK or AAB. <br />
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl bg-red-50 p-6">
          ...
          <ul className="space-y-1 text-sm text-red-800">
            ...
            <li>
              • <strong>Back up your keystore file</strong> – Store it securely
              in multiple locations
            </li>
            <li>
              • <strong>Save your passwords</strong> – Without them, you cannot
              sign app updates
            </li>
            <li>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h3 className="mb-3 font-semibold text-gray-900">📦 Prerequisites</h3>
          <p className="text-sm text-gray-700">
            The <code className="rounded bg-gray-100 px-1">keytool</code>{" "}
            command comes with the Java Development Kit (JDK). If you don't have
            it installed:
          </p>
