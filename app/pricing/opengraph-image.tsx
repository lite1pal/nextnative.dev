...
export default async function Image() {
  ...
  const title = "Pricing | NextNative"!.slice(0, 120);

  const desc =
    "Simple, one-time pricing for developers who want to ship cross-platform apps fast using Next.js and Capacitor."!.slice(
      0,
      160,
    );
